...
export const CHARACTER_POSITIONS: Record<string, CharacterPositions> = {
  ...
  whale: {
    hat: {
      hat_tophat: { top: -30, left: 9, width: 75 },
      hat_cap: { top: -25, left: 9, width: 75 },
      hat_cowboy: { top: -30, left: 9, width: 75 },
      hat_crown: { top: -37, left: 9, width: 75 },
      hat_beanie: { top: -50, left: 8, width: 85 },
      hat_wizard: { top: -35, left: 12, width: 75 },
    },
    glasses: {
