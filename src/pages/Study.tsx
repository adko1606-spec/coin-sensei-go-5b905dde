          ...
          <div className="flex items-center gap-3">
            {selectedCategory ? (
              ...
              >
                ...
                <span className="text-lg">Späť</span>
              </button>
            ) : (
              <>
                <img src={logo} alt="FinAp logo" className="h-20 w-20" />
                <h1 className="text-2xl font-extrabold text-primary">Učivo</h1>
              </>
            )}
          </div>
          ...
          {!selectedCategory ? (
            ...
            >
              <p className="text-muted-foreground text-sm text-center mb-2">
                Vyber si oblasť, ktorú chceš naštudovať pred lekciami 📖
              </p>
              {studyContent.map((category, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="mt-1 inline-block text-xs text-primary font-bold">
                      {category.topics.length} tém
                    </span>
                  </div>
            ...
            >
              ...
              <motion.button
                whileTap={{ scale: 0.97 }}
                onClick={() => navigate(`/lessons?category=${selectedCategory.id}`)}
              ...
              >
                📝 Prejsť na lekcie z tejto oblasti
              </motion.button>
            </motion.div>
          )}
        </AnimatePresence>
    ...
    {topic.example && (
      <div className="rounded-xl bg-accent/10 border border-accent/20 p-3">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs font-bold text-accent uppercase">Príklad</span>
        </div>
    ...
    {topic.tip && (
      <div className="rounded-xl bg-secondary/10 border border-secondary/20 p-3">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs font-bold text-secondary uppercase">Tip</span>
        </div>
